...
city_name="Chongqing"
coordinate_longitude=106.54
coordiante_latitude=29.59
print("The longitude of the {} coordinate is {lon:.2f}, and the latitude is {lat}.".format(city_name,lon=coordinate_longitude,lat=coordiante_latitude))

x,y,*z=0,1,2,3,4,5,6 #unpacking 序列解包。尝试，x,y,*z=0,1,2,3,4,5,6; x,y,*z=0,1; (x,y),(a,b)=(0,1),(2,3)
print(x,y,z)
x,y,*z=0,1
print(x,y,z)
(x,y),(a,b)=(0,1),(2,3)
...
lst_n=list(range(2,42,4)) #建立列表。range(start,stop,[,step])建立区间。
print(lst_n)
...
print(lst_s)
print("_"*50)
print("[0:10:2]->{}".format(lst_s[0:10:3]))
print("[::3]->{}".format(lst_s[::3]))
print("[9:3:-2]->{}".format(lst_s[9:3:-3]))
print("[20:3:-2]->{}".format(lst_s[20:3:-3]))
print("[7::-2]->{}".format(lst_s[7::-3]))
print("[:3:-2]->{}".format(lst_s[:3:-3]))
